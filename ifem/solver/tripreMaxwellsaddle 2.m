...
setupOption.freeDof = find(option.isFreeNode);
...
amgoption.printlevel = 0;
amgoption.setupflag = false;
amgoption.maxIt     = 1;
% minres for the saddle point system
[x,flag,stopErr,itStep,err] = gmres(bigA,bigF,20,tol,maxIt,@tripre);
...
%% Preconditioner   
    function e  = tripre(r)
        ...
        e2 = -mg(Ap,r2-G'*e1,elem,amgoption,Ai_N,Bi_N,BBi_N,Res_N,Pro_N);
        ge = grad*e2;
        e  = [e1 - ge; DMinv*(Ap*e2)];
    end
end