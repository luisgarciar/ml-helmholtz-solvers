...
%
% We explain degree of freedoms and basis functions for Crouzeix-Raviart
% nonconforming P1 element on triangles and tetrahedrons. The dofs are
% associated to edges (2-D) and faces (3-D). Given a mesh, the required
% data structure can be constructured by
%
