function [sigma,u] = HodgeLaplacian3F(node,elem,pde,bdFlag,option)
...
%% Assemble matrix 
% Mass matrices
Me = getmassmat3(elem2edge,volume,Dlambda,'ND0');
Mf = getmassmat3(elem2face,volume,Dlambda,'RT0');
...
%% Boundary Conditions
[AD,f,u,sigma,freeDof,isPureNeumann] = getbdHodgeLap3F(f);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [AD,f,u,sigma,freeDof,isPureNeumann] = getbdHodgeLap3F(f)
