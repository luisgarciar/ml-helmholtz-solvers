function [u,p,w,edge,eqn,info] = StokesBDM1B(node,elem,bdFlag,pde,option)
...
%% Output information
eqn = struct('A',A0,'B',B0,'f',f0,'g',g0,'ufreeDof',ufreeDof,'pDof',pDof,'Me',Meb,'Mv',Mv);
