function [A] = shift_laplace2var(kvar,b1,b2,npx,npy,bc)
%% SHIFT_LAPLACE2VAR: Constructs matrices for the 2D shifted Laplace problem.
%   with nonconstant wavenumber
%
%  Use: [A] =  shift_laplace2var(kvar,b1,b2,npx,npy,bc,flag)
%
%  Input: 
